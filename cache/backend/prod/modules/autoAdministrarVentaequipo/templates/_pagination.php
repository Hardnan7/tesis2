        ...
        <table align="center" class="sf_admin_pagination">
          <tbody>
            <tr>
              ...
              <td class="button">
                <a href="<?php echo url_for('@ventaequipo?page=1') ?>"<?php if ($pager->getPage() == 1) echo ' class="ui-state-disabled"' ?>>
                  <span class="ui-icon ui-icon-seek-first"></span>                </a>
              </td>

              <td class="button">
                <a href="<?php echo url_for('@ventaequipo?page='.$pager->getPreviousPage()) ?>"<?php if ($pager->getPage() == 1) echo ' class="ui-state-disabled"' ?>>
              ...
              <td class="button">
                <a href="<?php echo url_for('@ventaequipo?page='.$pager->getNextPage()) ?>"<?php if ($pager->getPage() == $pager->getLastPage()) echo ' class="ui-state-disabled"' ?>>
                  <span class="ui-icon ui-icon-seek-next"></span>                </a>
              </td>

              <td class="button">
                <a href="<?php echo url_for('@ventaequipo?page='.$pager->getLastPage()) ?>"<?php if ($pager->getPage() == $pager->getLastPage()) echo ' class="ui-state-disabled"' ?>>
