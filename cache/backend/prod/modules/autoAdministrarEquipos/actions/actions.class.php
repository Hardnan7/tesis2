...
require_once(dirname(__FILE__).'/../lib/BaseAdministrarEquiposGeneratorConfiguration.class.php');
...
abstract class autoAdministrarEquiposActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->equipo = $this->form->getObject();
  }
  ...
  {
    $this->equipo = $this->getRoute()->getObject();
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if ($request->hasParameter('_save_and_add'))
      {
        ...
        $this->redirect('@equipo_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'equipo_edit', 'sf_subject' => $equipo));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('equipo');
