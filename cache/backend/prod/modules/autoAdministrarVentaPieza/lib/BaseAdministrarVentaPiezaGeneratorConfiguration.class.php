...
/**
 * AdministrarVentaPieza module configuration.
 *
 ...
 */
class BaseAdministrarVentaPiezaGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%fecha%% - %%tipo%% - %%monto%% - %%detalle%% - %%cliente%% - %%gastos_envio%%';
  }
  ...
  {
    return 'AdministrarVentaPieza List';
  }

  public function getEditTitle()
  {
    return 'Edit AdministrarVentaPieza';
  }

  public function getNewTitle()
  {
    return 'New AdministrarVentaPieza';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'fecha',  2 => 'tipo',  3 => 'monto',  4 => 'detalle',  5 => 'cliente',  6 => 'gastos_envio',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'cliente' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
      'gastos_envio' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
    );
  }
  ...
  {
    return 'View AdministrarVentaPieza';
  }
