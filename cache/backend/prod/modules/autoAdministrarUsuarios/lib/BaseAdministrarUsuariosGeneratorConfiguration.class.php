...
/**
 * AdministrarUsuarios module configuration.
 *
 ...
 */
class BaseAdministrarUsuariosGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%rut%% - %%nombres%% - %%apellidos%% - %%email%% - %%fecha_nac%% - %%direccion%% - %%ciudad%% - %%telefono%%';
  }
  ...
  {
    return 'AdministrarUsuarios List';
  }

  public function getEditTitle()
  {
    return 'Edit AdministrarUsuarios';
  }

  public function getNewTitle()
  {
    return 'New AdministrarUsuarios';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'rut',  2 => 'nombres',  3 => 'apellidos',  4 => 'email',  5 => 'fecha_nac',  6 => 'direccion',  7 => 'ciudad',  8 => 'telefono',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'ciudad' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
