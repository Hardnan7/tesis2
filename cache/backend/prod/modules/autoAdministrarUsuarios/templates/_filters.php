    ...
    <table>
        ...
        <tr>
          <td colspan="2">
            <div style="text-align:right">
              ...
              <?php echo link_to(__('Reset', array(), 'sf_admin'), 'usuario_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' =>  'fg-button ui-state-default ui-corner-all', 'id' => 'sf_admin_filter_reset')) ?>
      ...
      <tbody>
        <?php foreach ($configuration->getFormFilterFields($form) as $name => $field): ?>
          ...
          <?php include_partial('AdministrarUsuarios/filters_field', array(
            'name'       => $name,
