...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@pieza') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('AdministrarPiezas/form_actions', array('pieza' => $pieza, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
