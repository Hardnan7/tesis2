...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@empleado') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('AdministrarEmpleados/form_actions', array('empleado' => $empleado, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
